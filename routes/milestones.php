...
Route::group([
    ...
    ])->can('index', \GammaMatrix\Playground\Matrix\Models\Milestone::class);
    ...
    ])->can('create', \GammaMatrix\Playground\Matrix\Models\Milestone::class);
    ...
    // ])->can('store', \GammaMatrix\Playground\Matrix\Models\Milestone::class);
