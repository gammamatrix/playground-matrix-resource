    ...
    <div class="card-header">
        @if (! empty($modelColumn) && ! empty($modelLabel))
            <a
                ...
                href="{{ route("playground.matrix.resource.versions.create", [$modelColumn => $data->id, "_return_url" => $routeShow]) }}"
                alt=" {{ __("Create a new version for the :model_label", ["model_label" => $modelLabel]) }}"
            >
                {{ __("Create") }}
            </a>
        @endif
        ...
        <div class="card-body">
            ...
            >
                ...
                <div
                    ...
                    role="toolbar"
                    aria-label="{{ __("Version Form") }}"
                >
                    <div class="input-group w-100">
                        <select
                            class="form-select"
                            aria-label="{{ __("set the version") }}"
                            name="version_id"
                            required
                        >
