<fieldset class="mb-3">
    ...
    if ('patch' === $_method) {
        ...
        $parents = Playground\Matrix\Models\Epic::isNotClosed()->isActive()->get();
    }
    @endphp
    @if ($parents->isEmpty())
    <input type="hidden" name="parent_id" value="" />
    @else
    <x-playground::forms.column-select column="parent_id" key="label" label="Epic" :records="$parents->toArray()"/>
    @endif
