<fieldset class="mb-3">
    ...
    <x-playground::forms.column column="note_type" label="Note Type" :rules="['maxlength' => 255]" />
    ...
    if ('patch' === $_method) {
        ...
        $parents = Playground\Matrix\Models\Note::isNotClosed()->isActive()->get();
    }
    @endphp
    @if ($parents->isEmpty())
    <input type="hidden" name="parent_id" value="" />
    @else
    <x-playground::forms.column-select column="parent_id" key="label" label="Note" :records="$parents->toArray()"/>
    @endif
